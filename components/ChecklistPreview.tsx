        ...
        <table className="w-full border-collapse border-2 border-black text-sm text-center">
          <tbody>
            <tr className="border-b border-black h-12">
              ...
              <td className="border-r border-black w-32 font-bold">{data.productCode}</td>
              <td className="bg-gray-50 font-bold border-r border-black w-24">상품명</td>
              <td className="text-left px-3 font-bold" colSpan={5}>{data.productName}</td>
            </tr>
            <tr className="border-b border-black h-12">
              ...
              <td className="border-r border-black w-32 font-bold">{data.model}</td>
            ...
            <tr className="h-12">
              ...
              <td className="text-left px-3 font-bold" colSpan={3}>{data.serialNumber}</td>
            </tr>
          </tbody>
        </table>
      </div>

      {/* Footer Row: Toggle Selection */}
      <div className="mt-6 flex justify-between text-sm items-center px-1">
        <div className="flex gap-16">
          <div className="flex items-center gap-2">
            <span className="font-semibold text-gray-800">물류:</span>
            <span className={`w-12 h-8 border-b-2 border-gray-400 flex items-center justify-center text-xl font-black ${data.category === '물류' ? 'text-blue-600' : 'text-transparent'}`}>
              O
            </span>
          </div>
          <div className="flex items-center gap-2">
            <span className="font-semibold text-gray-800">건설:</span>
            <span className={`w-12 h-8 border-b-2 border-gray-400 flex items-center justify-center text-xl font-black ${data.category === '건설' ? 'text-blue-600' : 'text-transparent'}`}>
              O
            </span>
          </div>
        </div>
